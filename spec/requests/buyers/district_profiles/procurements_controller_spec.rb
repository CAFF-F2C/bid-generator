...
RSpec.describe Buyers::DistrictProfiles::ProcurementsController, type: :request do
  describe 'GET #edit' do
    ...
    context 'when a buyer is signed in' do
      ...
      context 'when a buyer has no district profile' do
        it 'redirects to the district profile page' do
          make_request
  ...
  describe 'PATCH #update' do
    ...
    def make_draft_request(params = {})
      patch buyers_district_profile_procurement_path(district_profile: params, draft: true)
    end
